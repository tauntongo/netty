...
public class ByteToMessageDecoderTest {
    ...
    public void testDisorder() {
        ...
        assertEquals(Byte.valueOf((byte) 1),  channel.readInbound());
        assertEquals(Byte.valueOf((byte) 2),  channel.readInbound());
        assertEquals(Byte.valueOf((byte) 3),  channel.readInbound());
        assertEquals(Byte.valueOf((byte) 4),  channel.readInbound());
